...
doc_events = {
    "Payment Entry": {
    "on_submit": "vortex.custom.payment_entry.generate_pdf_and_send_whatsapp_on_submit_payment"
    },
    "Payment Request": {
...
override_doctype_class = {
    ...
    "Payment Request":"vortex.overrides.payment_request.CustomPaymentRequest"
}
