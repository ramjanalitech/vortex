...
frappe.query_reports["Accounting Dimension Wise Balance Sheet"] = {
	...
	onload: function(report) {
		...
		frappe.call({
			method: "accounting_dimension_wise_financials.accounting_dimension_wise_financials.report.accounting_dimension_wise_profit_and_loss_statement.accounting_dimension_wise_profit_and_loss_statement._get_accounting_dimensions",
			callback: function(r) {
